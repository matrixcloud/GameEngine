...
public class Maths {
	...
	public static Matrix4f createTransformMatrix4(Vector3f translation, float rx, float ry, float rz, float scale) {
		Matrix4f mat4 = new Matrix4f();
		mat4.setIdentity();
		Matrix4f.translate(translation, mat4, mat4);
		Matrix4f.rotate((float) Math.toRadians(rx), new Vector3f(1, 0, 0), mat4, mat4);
		Matrix4f.rotate((float) Math.toRadians(ry), new Vector3f(0, 1, 0), mat4, mat4);
